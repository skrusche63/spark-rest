...
class RecomMaster extends BaseActor {
  ...
  private def ctx = new RemoteContext()
  ...
  protected def actor(worker:String):ActorRef = context.actorOf(Props(new RecomWorker(ctx)))
